...
3. knit my .Rmd file to a `word_document` and send this to Google Drive for comments / revisions from co-authors. I do this using the **googledrive** R package `r emo::ji("package")`. 
...
Here is an example for what a portion of my original mind-map looked like.
