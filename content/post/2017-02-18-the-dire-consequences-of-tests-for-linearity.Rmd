...
* generate 100 data points from two independent random normal distributions, an outcome $y$ and a predictor $x$. 
...
<span style="color:#EB6864; font-size: 20pt"> [Type 1 error when removing non-significant nonlinear terms ]</span>
