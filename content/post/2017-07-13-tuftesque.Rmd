...
Now that you have your blogdown blog up and running switch back to your R onsole (you may have to press escape to kill the running blogdown server) and run the following command to download the tuftesque theme from github. 
