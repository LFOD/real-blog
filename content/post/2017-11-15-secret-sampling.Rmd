...
We had our interested classmates sign up on a Google Form,`r tufte::margin_note("![](/images/2017-11-14/google-form.png)")` resulting in a Google Sheet with each participant's `name`, `email`, and `interests`.
