...
Or like this! (Thanks to our #livefreeordichtomize partner in crime `r emo::ji("dancing_women")`) 

<blockquote class="twitter-tweet" data-conversation="none" data-lang="en"><p lang="en" dir="ltr">IGNORE THIS! I MESSED IT UP. Here&#39;s my better one<br>sample(names) %&gt;% {<br> data_frame(<br> name = ., <br> paired = c(tail(., length(names)-1), .[1])<br> )}</p>&mdash; Nick Strayer (@NicholasStrayer) <a href="https://twitter.com/NicholasStrayer/status/930883556209053697?ref_src=twsrc%5Etfw">November 15, 2017</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script> 
