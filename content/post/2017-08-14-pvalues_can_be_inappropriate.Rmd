...
author: "Nick Strayer"
date: '2017-08-14'
categories: ["p-values", "statistics"]
tags: ["shinysense", "shiny", "rmarkdown", "javascript", "rstats"]
excerpt: "There seems to be an uptick of citations of different studies or statistics about this or that in the news and on the internet. Through a small contrived example I make the point that perhaps in some situations we should ignore the forest and focus on the trees."
---
...
Based on this concrete evidence, you decide to go to Sheela's Sashimi and come back mildly satisfied. Soon, your coworker who didn't look at the rating website comes back from Tony's Tacos and raves about the food. You, disappointing and confused as to how this could be, decide to go back to the food rating service and pull all reviews for Tony's Tacos and Sheelas Sashimi from their handy dandy reviews api...
...
P-values and indeed much of common statistical methodology relies on summary statistics. This fact is very easy to forget, I do all the time and I'm literally payed to understand statistics. 
