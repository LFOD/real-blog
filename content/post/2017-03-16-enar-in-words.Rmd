...
Pro Tip: be sure to enter `http://127.0.0.1:1410`  <br/>
as your `Callback URL`. If you get lost, there is a <br/>
...
<p style = "text-align: right; color: #EB6864; font-size: 10pt; LINE-HEIGHT:15px;">
My original tutorial used `twitteR`, but [Maëlle](https://twitter.com/ma_salmon)  <br/>
kindly pointed out that it is on the way out and </br>
...
```{r, eval = FALSE}
load(url("https://github.com/LFOD/real-blog/raw/master/static/data/enar_data.rda"))
```
