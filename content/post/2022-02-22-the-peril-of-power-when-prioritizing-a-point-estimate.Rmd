...
In order to have a probability of success greater than 80%, for example, the childrens' antibody response would need to be at least $0.84 \times$ standard errors **better** than the adolescents'. To have a probability of success greater than 90%, the childrens' antibody response would need to be at least $1.28 \times$ standard errors **better** than the adolescents'. 
