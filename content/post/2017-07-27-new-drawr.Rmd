...
__Timeseries support:__ It is kind of silly that the function didn't support timeseries before, these visualizations are almost exclusively used with time on the x-axis so obviously that should be supported. `r tufte::margin_note("Stick around for a demo.")`
