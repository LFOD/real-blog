...
N`r tufte::margin_note(paste("Emoji tip: You can include emoji in your git commit messages by keyword - checkout [this list](https://gist.github.com/rxaviers/7360908)", emo::ji("tada"), emo::ji("beers"), emo::ji("rooster")))`ow we just have to add commit and push everything to GitHub. In the upper right corner of RStudio, you should see a "Git" tab. Click the "Commit" button. The following box should pop up.
