...
## RMarkdown & Pagedown
`r tufte::margin_note("RMarkdown is just one of a good number of tools that allow you to use the [literate programming paradigm](https://en.wikipedia.org/wiki/Literate_programming), popularized by the computer scientist Donald Knuth.")`
