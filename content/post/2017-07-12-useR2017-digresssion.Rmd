...
`r tufte::newthought("Brussels was *incredible*.")` The `r emo::ji("beer")` was delectable and the people were delightful. `r tufte::margin_note("This proved to be particularly useful when we temporarly misplaced our travel buddy Jacquelyn on our way from the ✈️ - we convinently followed the signs to wifi!")` It was quite simple to navigate, and as an added bonus the conference had set up lovely bread-crumb-esque signs from the train station to the main site at the Wild Gallery, making it even easier for the directionally challenged or GPS-less conference attendees.
...
`r tufte::newthought("Nick and I shared many favorites!")` A few others that warrant mentioning:
...
<img  src="/images/double_rainbow.jpg" alt="rainbow" style="width:100%">
<div class="caption">
<p>Iceland, where the (double) rainbow starts and ends.</p>
</div>
