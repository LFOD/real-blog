...
Some may be annoyed by the fact that the conference won't be back in the US next year but I personally think this is beneficial. `r tufte::margin_note("Besides, [Nick Tierny](https://twitter.com/nj_tierney) _may_ have told me that conference transportation next year will be provided by Kangaroos and Ostriches, so like, that's worth it. ")` As Angela Merkel has similarly expressed recently, the US is slipping a bit in it's hold on the "go-to" place. 
...
__Nick:__ I have never been to a conference where almost every single talk I went to was as high-quality and fantastic as useR. I truly learned something at every single one and can't wait to apply the concepts to my own R and statistics related projects. Obviously I can't write up a thing on 30 different talks so I'll include a randomly selected few that stuck out to me. 
...
<div class="row">
 <div class="col-md-8">
  <div class="thumbnail "col-md-8">
   <a href="/images/double_rainbow.jpg"> <img class = "img-responsive" src="/images/double_rainbow.jpg" alt="Vandy Represent" style="width:100%" /> </a>
   <div class="caption"> <p>Iceland, where the (double) rainbow starts and ends.</p> </div>
  </div>
 </div>
</div>
...
__Lucy:__ After Bruges, we ventured off to Iceland for a few days. It was absolutely magical. Icelandair has a great stopover program where you can book a flight with an extended stopover for the same cost as an ordinary layover -- it was *marvelous* -- this may become a new tradition for my European travel.
...
<div class="caption">
<p style: "width:100% !important">Glacier SELFIE!</p>
</div>
</a>
</div>
</div>
